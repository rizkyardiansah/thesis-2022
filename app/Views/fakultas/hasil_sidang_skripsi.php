    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="prodi" name="prodi" class="form-control" value="<?= $prodi['nama'] ?>" disabled>
                    </div>
                </div>
                <div class="col-12">
                   <div class="form-group">
            ...
            <div class="col-lg-12 my-2 d-flex justify-content-end">
                <a class="btn btn-secondary mr-2" role="button" href="<?= base_url("fakultas/skripsi") ?>">Kembali</a>
            </div>
        </div>
    </div>
