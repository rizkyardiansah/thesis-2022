        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-7 d-flex justify-content-end align-items-center">
                    <form class="form-inline" action="<?= base_url("dosen/kaprodiSkripsi") ?>" method="get">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="kaprodiSkripsi" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>NPM</th>
...
<?= $this->section("scripts"); ?>
    <script src="<?= base_url("assets/js/dosen/kaprodiSkripsi.js");?>"></script>
<?= $this->endSection(); ?>