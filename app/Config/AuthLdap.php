...
class AuthLdap extends BaseConfig
{
     ...
     */
    private $ldapDomain = 'pdc.yarsi.ac.id';
     ...
     * @var string $baseDn
     */
    private $baseDn = 'dc=yarsi,dc=ac,dc=id';
    private $groupsDn = 'ou=Groups,dc=yarsi,dc=ac,dc=id';
     ...
     */
    private $ldapGroupAttribute = 'cn';

	/**
	 * LDAP search Attribute
	 * @var string[] $ldapSearchAttribute
	 */
	private $ldapSearchAttribute = ['dn', 'cn', 'displayName', 'telephoneNumber', 'description', 
		'homePhone', 'street', 'homePostalAddress', 'title'];
	 ...
	 */
	private $ldapMemberOfGroupsIdentifier = 'cn';
    ...
    public function getLdapGroupsDN(): string
	{
