...
$jscomp.polyfillUnisolated = function (b, h, g, l) {
  ...
  h != l &&
    null != h &&
    $jscomp.defineProperty(g, b, { configurable: !0, writable: !0, value: h });
};
  ...
  b.extend(t.prototype, {
    ...
    _scroll: function (a) {
      if (!this.s.dt.settings()[0].bDestroying) {
        ...
        this.c.header &&
          (this.s.enable
            ? !m.visible || q + this.c.headerOffset + m.theadHeight <= u
              ? (n = "in-place")
              ...
              : (n = "below")
            : (n = "in-place"),
          (a || n !== this.s.headerMode) && this._modeChange(n, "header", a),
        ...
        this.c.footer &&
          ...
          d &&
            ...
            (r =
              r +
              (d > -x.height ? d : 0) -
              (x.offset.top + (d < -x.height ? x.height : 0) + y.height)),
            0 > r && (r = 0),
            c.outerHeight(r),
          ...
          ((c = function (A, C, v) {
            v === l &&
              ...
              (v =
                0 === v.length
                  ? null
                  : v.clone().appendTo("body").css("z-index", 1)));
            null !== v &&
              v.css({
